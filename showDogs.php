            ...
            ?>
                ...
                ?>
                    <div class="pet-card">
                        ...
                        <div class="actions">
                            <a class="" href="editPet.php?pet_id=<?php echo $row['id']; ?>"> <img src="assets/material-symbols_edit.svg" alt="" srcset="">Edit</a>
                            <a href="confirmDelete.php?pet_id=<?php echo $row['id']; ?>"><img src="assets/mingcute_delete-fill.svg" alt="" srcset="">Delete</a>
                        </div>
                    </div>
            <?php
