...
<body>
    ...
    <section class="edit-petForm" >
        <div>
            <div>
                <div>
                    <h1>Pet Information is now updated!</h1>
                    <p>Thank you for providing us with your pet's information. </p>
                ...
                <!-- <form id="confirmationForm" action="../includes/includes_myPets.php" method="post">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <div><input type="radio" name="species" id="species-radio1" value="Dog" <?php if ($pet['species'] === "Dog") {
                                                                                                        echo "checked";
                                                                                                    } ?>> <span for="">Canine(Dogs)</span></div>
                            <div><input type="radio" name="species" id="species-radio2" value="Cat" <?php if ($pet['species'] === "Cat") {
                                                                                                        echo "checked";
                                                                                                    } ?>><span for="">Feline(Cats)</span></div>
                            <div><span>Others:</span>
                                <input name="species" type="text" id="otherSpeciesInput" placeholder="Others" <?php if ($pet['species'] != "Dog" && $pet['species'] != "Cat") echo $pet['species']  ?>>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col"><button  name="updatePet" type="submit" value="Confirm">Add My Pet</button></div>
                </form> -->
            </div>
            <div>
                <div>
